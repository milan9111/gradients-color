...
const EditContainer = ({setColors}) => {
    ...
    const [editFirstColor, setEditFirstColor] = useState(selectedColor[0].firstColor);
    const [editSecondtColor, setEditSecondColor] = useState(selectedColor[0].secondColor);
    ...
    useEffect(() => {
      validSaveFirstColor === true && validSaveSecondColor === true ? setSaveEditDisable(false) : setSaveEditDisable(true);
    ...
    return (
      <div>
         <Edit editFirstColor={editFirstColor} editSecondColor={editSecondtColor} onEditFirstColor={onEditFirstColor} onEditSecondColor={onEditSecondColor} saveEditDisable={saveEditDisable} saveEditColor={saveEditColor}/>
      </div>
    );
  }
