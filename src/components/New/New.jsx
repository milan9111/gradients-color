...
const New = ({changeFirstColor, changeSecondColor, addGradient, activeDisable}) => {
    ...
    return (
      <section className="new__container">
          <div className='new__title title'>
              new
          </div>
          <div className='new__inputs'>
              <div className='input'><input type="text" placeholder="#..." onChange={changeFirstColor} /></div> 
              <div className='input'><input type="text" placeholder="#..." onChange={changeSecondColor}/></div>
          </div>
